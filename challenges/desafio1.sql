...
CREATE TABLE musicas (
    ...
    musica_duracao SMALLINT UNSIGNED NOT NULL,
...
CREATE TABLE pessoas_usuarias (
    ...
    pessoa_usuaria_nome VARCHAR(255) NOT NULL,
    pessoa_usuaria_idade SMALLINT NOT NULL,
    pessoa_usuaria_data_assinatura VARCHAR(11) NOT NULL,
...
CREATE TABLE musicas_ouvidas (
    pessoa_usuaria_id INT NOT NULL,
    musica_id INT NOT NULL,
    musica_data_ouvida DATETIME NOT NULL,
    FOREIGN KEY (pessoa_usuaria_id) REFERENCES pessoas_usuarias (pessoa_usuaria_id),
    FOREIGN KEY (musica_id) REFERENCES musicas (musica_id),
    PRIMARY KEY (pessoa_usuaria_id, musica_id)
);

INSERT INTO planos (plano_nome, plano_preco) VALUES
  ('gratuito', 0.00),
  ('universitário', 5.99),
  ('pessoal', 6.99),
  ('familiar', 7.99);
...
INSERT INTO albums (album_nome, album_lancamento, artista_id) VALUES
  ('Renaissance', 2022, 1),
  ('Jazz', 1978, 2),
  ('Hot Space', 1982, 2),
...
INSERT INTO pessoas_usuarias (pessoa_usuaria_nome, pessoa_usuaria_idade, pessoa_usuaria_data_assinatura, plano_id) VALUES
...
INSERT INTO artistas_seguidos (pessoa_usuaria_id, artista_id) VALUES
  (1, 1),
  (1, 2),
  (1, 3),
  (2, 1),
...
INSERT INTO musicas ( musica_nome, album_id, musica_duracao) VALUES
  ...
  INSERT INTO musicas_ouvidas (pessoa_usuaria_id, musica_id, musica_data_ouvida) VALUES
